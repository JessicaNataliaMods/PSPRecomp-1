...
L_089CF58C:
    ...
    aot_mem.aot_store_word_right(ctx.gpr[29] + static_cast<std::uint32_t>(15), ctx.gpr[1]);
    aot_mem.aot_store_word_left(ctx.gpr[29] + static_cast<std::uint32_t>(18), ctx.gpr[1]);
