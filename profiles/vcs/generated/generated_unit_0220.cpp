...
static constexpr std::uint64_t kEntryMasks_recomp_unit_0220[38] = {
    0x0402000029020009ull, 0x0010000000000001ull, 0x8008004080410801ull, 0x0400810081042000ull,
    0x0008404000420404ull, 0x0000000000000000ull, 0xA0C400000A500000ull, 0x00000000000094AEull,
...
static constexpr std::uint16_t kEntryBases_recomp_unit_0220[38] = {
    1u, 9u, 11u, 19u, 26u, 33u, 33u, 42u, 50u, 50u, 50u, 50u, 50u, 50u, 50u, 50u,
...
LOCAL_DISPATCH:
    ...
    if (entry_id == 0u) {
        ...
        entry_id = 0u;
        if (entry_delta < 9708u && (entry_delta & 3u) == 0u) {
            const std::uint32_t entry_slot = entry_delta >> 2u;
            const std::uint32_t entry_group = entry_slot >> 6u;
            const std::uint64_t entry_mask = kEntryMasks_recomp_unit_0220[entry_group];
            const std::uint64_t entry_bit = 1ull << (entry_slot & 63u);
            if ((entry_mask & entry_bit) != 0u) {
                entry_id = static_cast<std::uint16_t>(
                    kEntryBases_recomp_unit_0220[entry_group] +
...
void register_generated_unit_220(Runtime &runtime) {
    ...
    runtime.register_generated_entry_mask(0x08B74000u, &recomp_unit_0220, "recomp_unit_0220",
                                          kEntryMasks_recomp_unit_0220, 38u);
}
} // namespace psprecomp
