...
need(('stage=perf-v8.6-radio-identity-vfpu-ct2-2026-08-18' in log) or ('stage=perf-v8.7-extreme-cpu-tiny-leaf-2026-08-18' in log),'V8.6 lineage stage')
need((('perf_layer=12' in log and 'cpu_aggressive_revision=6' in log) or ('perf_layer=13' in log and 'cpu_aggressive_revision=7' in log)) and 'correctness_revision=8272' in log,'V8.6/V8.7 revisions')
