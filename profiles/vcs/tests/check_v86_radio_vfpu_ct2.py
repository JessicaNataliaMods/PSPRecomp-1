...
need('stage=perf-v8.6-radio-identity-vfpu-ct2-2026-08-18' in log,'V8.6 stage')
need('perf_layer=12' in log and 'cpu_aggressive_revision=6' in log and 'correctness_revision=8272' in log,'V8.6 revisions')
