...
need(('stage=perf-v8.5-aggressive-vfpu-fastlane-2026-08-18' in log) or ('stage=perf-v8.6-radio-identity-vfpu-ct2-2026-08-18' in log) or ('stage=perf-v8.8-extreme-cpu-trusted-dispatch-2026-08-18' in log) or ('stage=perf-v8.9-extreme-cpu-register-residency-2026-08-18' in log) or ('stage=perf-v8.10-extreme-cpu-resident-regions-2026-08-18' in log), 'V8.5 lineage stage stamp')
need((('perf_layer=11' in log and 'cpu_aggressive_revision=5' in log) or ('perf_layer=12' in log and 'cpu_aggressive_revision=6' in log) or ('perf_layer=14' in log and 'cpu_aggressive_revision=8' in log) or ('perf_layer=15' in log and 'cpu_aggressive_revision=9' in log) or ('perf_layer=16' in log and 'cpu_aggressive_revision=10' in log)), 'V8.5/V8.6 performance revision metadata')
for token in (
